(function (factory, window) {
    ...
    var CanvasIconLayer = (L.Layer ? L.Layer : L.Class).extend({
        ...
        /**
         * [addLayerByLngLat 根据经纬度来展示数据]
         * @param {[type]} latlng [description]
         */
        addLayerByLngLat: function (markerObject) {
            if (!this.markerObjects) {
                this.markerObjects = [];
            }
            if (this.options.callback) {
                this.options.callback(markerObject, this._context);
        ...
        clearLayer: function () {
            ...
            if (this.markerObjects) this.markerObjects = [];
        },
        ...
        _redraw: function (clear) {
            ...
            if (this.options.callback) {
                for (var i in this.markerObjects) {
                    this.options.callback(this.markerObjects[i], this._context);
                }
            } else {
        ...
        _initCanvas: function () {
            ...
            if (this.options.zIndex) {
                this._canvas.style["z-index"] = this.options.zIndex;
            }

            if (this.options.mousemove) {
                var mousemoveback = this.options.mousemove;
