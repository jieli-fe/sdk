...
import { getDirecIcon } from "./ShipCommon";
...
class VoyagePointUtil {
    ...
    //求相连两个点的中间点
    getRotatePoint(dataArray, mapview=L._map) {
     ...
     *
     */
    getDirectionLayer(dataArray, mapview=L._map) {
        if (!dataArray) return;
     ...
     *olddataArray：原始数组*
     */
    spaVoyageDirec(data, olddataArray, mapview=L._map) {
